...
INSERT INTO `alimentacion` VALUES (11,23,'2022-04-01','Lleno','Sucio','3'),(12,26,'2002-12-12','Lleno','Limpio','3'),(13,1,'1211-12-12','Vacio','Limpio','3'),(14,4,'2022-06-02','Lleno','Limpio','3');
...
INSERT INTO `datospollos` VALUES (3,'Mortalidad',20,'Medio',23,2,2,'Ninguna',3),(9,'Tratamiento',10,'Medio',26,1,2,'ninguna',3);
...
INSERT INTO `galpones` VALUES (29,26,'34x120',1200,1,'Pequeno','Act',3),(30,23,'12x13',1234,2,'Grande','Act',3),(37,1,'10x10',1,2,'Pequeno','Act',3),(38,4,'10 X 11',100,1,'Grande','Act',3);
...
INSERT INTO `herramientastemperatura` VALUES (11,'PC',100,'Nuevas','2022-04-02',120.00,12000.00,'Ninguna','Nueva',3);
...
--
-- Table structure for table `insumocuidado`
--

DROP TABLE IF EXISTS `insumocuidado`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `insumocuidado` (
  `codigo` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `insumocuidado`
--

LOCK TABLES `insumocuidado` WRITE;
/*!40000 ALTER TABLE `insumocuidado` DISABLE KEYS */;
INSERT INTO `insumocuidado` VALUES (1,'Balanceado','Engorde',3,'2002-11-11',100.00,300.00,3);
/*!40000 ALTER TABLE `insumocuidado` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `insumoproduccion` VALUES (5,'Detergente',25,'2020-11-11',50.00,1350.00,3,'Ingreso'),(7,'Vitaminass',40,'2022-12-02',2.00,6.00,3,'Egreso');
...
INSERT INTO `maqv_tblempleado` VALUES (1,'Roxana','Karina','Isea','Leon','1991-03-04','Femenino',3),(2,'Julian','Martin','Juarez','Cando','1998-08-08','Masculino',3),(3,'Juan','David','Yaselga','Lincango','1998-03-19','Masculino',3);
...
INSERT INTO `maqv_tblempresa` VALUES (3,'1725261521001','Femavi','Guayaquil');
...
INSERT INTO `maqv_tblusuario` VALUES (2,'lex','sd','alexander.roberto1999@hotmail.com','admin','Femavi.2022',1,'Act'),(4,'Mario','Lase','jorgito@gmai.com','usu2020','pass2020',2,'Act');
...
INSERT INTO `parametrostemperatura` VALUES (6,23,35,30,75,3);
...
INSERT INTO `tbldistribucion` VALUES (1,7,23,1),(2,5,23,1),(3,5,26,12),(4,5,26,12),(5,7,26,1),(6,5,23,5);
...
-- Dump completed on 2022-06-03  3:59:01
