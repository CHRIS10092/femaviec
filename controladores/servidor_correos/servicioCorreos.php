...
class ServicioCorreos extends config
{
    ...
    private $host_correo     = "localhost";
    private $correo_origen   = "koriche001@gmail.com";
    private $password_correo = "Jayden.2020";
    ...
    public function enviar_correo($cuenta_correo)
    {
        ...
        $link = "http://localhost/femaviec/nueva_clave.php?xir2sde9890d45sdebWES1Q=" . password_hash($cuenta_correo, PASSWORD_DEFAULT);
