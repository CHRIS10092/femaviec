	...
	<form id="frmVenta">
		...
		<div class="row">
			...
			<div class="col-md-3">
				...
				<input type="text" placeholder="Nombres y apellidos" id="cliente" name="cliente" class="form-control input-sm">
			</div>
			<div class="col-md-3">
		...
		<div class="row">
			<div class="col-md-1">
				<button class="btn btn-success btn-sm" data-toggle="modal" data-target="#m-productos" style="margin-top:22px">
					<i class="fa fa-search"></i>
				</button>
			</div>
			<div class="col-md-6">
