		...
		<!--[if !IE]> -->
		<script src="../contenido/assets/js/jquery-2.1.4.min.js"></script>
...
<![endif]-->
		<script type="text/javascript">
			if('ontouchstart' in document.documentElement) document.write("<script src='contenido/assets/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
		</script>
		<script src="../contenido/assets/js/bootstrap.min.js"></script>
